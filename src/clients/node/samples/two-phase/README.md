...
# Basic, Node.js SampleThis project creates two accounts (`1` and `2`) and
...
---
title: Two-Phase Transfer, Node.js Sample
---

This file is generated by
[src/clients/docs_generate.zig](/src/clients/docs_generate.zig).
# Two-Phase Transfer, Node.js SampleThis project creates two accounts (`1` and `2`) and begins a
